"""
Django settings for authproxy project.
...
SECRET_KEY = "django-insecure-rp@8#a2fw()gvt0#8*r(p11$dxf5@7n@a2ysbho#l7d^4y5k!2"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost"]
AUTH_USER_MODEL = "rdf4j.User"


# Application definition

INSTALLED_APPS = [
    "rdf4j.apps.Rdf4JConfig",
...
WSGI_APPLICATION = "authproxy.wsgi.application"
